...
parser.add_argument('--data-name', default='asia_200k', help='graph dataset name')
parser.add_argument('--nvt', type=int, default=8, help='number of different node types, \
...
args.res_dir = os.path.join(args.file_dir, '{}_{}dim_latent_KL{}_{}_hs{}_batchsize{}_lr{}/{}_{}'.format(args.data_name,args.beta,args.model,
                                                                                                          args.hs,args.batch_size,args.lr, 
...
if not args.keep_old:
    ...
    copy('train_original.py', args.res_dir)
